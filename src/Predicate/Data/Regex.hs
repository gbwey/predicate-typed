...
-- Val [("123.",["."]),("8.",["."]),("99.",["."]),("21",[])]
--
-- >>> pl @(MapF Fst (Rescan "." << ShowP Id) >> Filter (Same "2") Id) 12324
...
-- Val ["123","2","3","5","6"]
--
-- >>> pl @(MapF (ReadP Int Id) (Resplit "\\.") >> '(Id, '(Len == 4, All (0 <..> 0xff)))) "141.214.125.1.2.3333"
...
--
-- >>> pl @(MapF (ReadP Int Id) (Resplit "\\.") >> Id &&& ((Len == 4) &&& All (0 <..> 0xff))) "141.214.125.1.2.6"
